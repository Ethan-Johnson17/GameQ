  ...
  <nav class="
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto">
        <li>
          <router-link :to="{ name: 'GameCloset' }" class="btn text-ep selectable text-uppercase text-light">
            Game Closet
          </router-link>
        </li>

        <li>
          <router-link :to="{ name: 'Search' }" class="
              btn
              text-ep
              selectable
        ...
        <li>
          <router-link :to="{ name: 'GameNight' }" class="btn text-ep selectable text-uppercase text-light">
            Game Night
          </router-link>
        </li>
      </ul>
      <button class="btn btn-light me-5" title="Host Game" data-bs-target="#hostModal" data-bs-toggle="modal">
        Host Game
      </button>
      <span class="navbar-text">
        <button class="btn selectable text-ep text-light text-uppercase my-2 my-lg-0" @click="login"
        ...
        <div class="dropdown my-2 my-lg-0" v-else>
          ...
          <div class="dropdown-menu p-0 list-group w-100" aria-labelledby="authDropdown">
            ...
            <div class="list-group-item list-group-item-action hoverable" data-bs-target="#accountModal"
