<template>
  <div class="offcanvas-body p-1">
    ...
    <div class="col" v-if="game.min_players !== game.max_players">
      {{ game.min_players }} to {{ game.max_players }} players
    </div>
    <div class="col" v-else>{{ game.min_players }} players</div>
    <div class="col">
      {{ game.min_playtime }} to {{ game.max_playtime }} minute playtime
    </div>
    <div class="col mt-2" v-html="game.description"></div>
