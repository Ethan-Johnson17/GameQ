            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li v-for="game in closetGames" :key="game.atlasGameId">
                <div
                  ...
                  @click="state.selected1 = '{{game.name}}'"
                >
                  {{ game.name }}
                </div>
              </li>
          ...
          <div class="dropdown mx-4 my-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
              <li v-for="game in closetGames" :key="game.atlasGameId">
                <div
                  class="dropdown-item selectable"
                  @click="state.selected2 = '{{game.name}}'"
                >
                  {{ game.name }}
                </div>
              </li>
          ...
          <div class="dropdown mx-4 my-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
              <li v-for="game in closetGames" :key="game.atlasGameId">
                <div
                  class="dropdown-item selectable"
                  @click="state.selected3 = '{{game.name}}'"
                >
                  {{ game.name }}
                </div>
              </li>
...
export default {
  setup() {
    ...
    const state = reactive({
      editable: {},
      selected1: 'Select a game:',
      selected2: 'Select a game:',
      selected3: 'Select a game:',
    });
    return {
