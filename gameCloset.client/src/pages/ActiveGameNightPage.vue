                ...
                <div class="vote d-flex">
                  <div v-if="player">
                    <i class="
                        ...
                        h-25
                        me-2
                      " @click="vote(g.id)" v-if="!g.votes.includes(account.id)"></i>
                    <i class="
                        mdi mdi-thumb-up
                        text-secondary
                        f-16
                  ...
                  <p class="mb-0 selectable" data-bs-toggle="offcanvas" :data-bs-target="'#gameDetails-' + g.game.id">{{
                    g.game?.name }}</p>
                  <i class="
                      mdi mdi-trash-can
                      f-20
              ...
              <div class="col-md-10 bg-primary mb-3 pb-2 mx-2">
                ...
                <div class="row" v-for="gq in sortedGameQueue" :key="gq.id">
                  <div class="col-9 my-2 mdi" v-if="gq == sortedGameQueue[0]">{{
                    gq.game?.name }} <i class="mdi mdi-chess-king ms-1">
                    </i>
                    <hr>
                  </div>
                  <div class="col-9 my-2 mdi" v-else>{{
                    gq.game?.name }}
                  </div>
