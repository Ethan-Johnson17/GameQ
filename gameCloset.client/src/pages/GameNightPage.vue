    ...
    return {
      ...
      async cancelGameNight(gameNightId) {
        try {
          ...
          Pop.toast("You've canceled this GameNight.", 'success')
        } catch (error) {
          logger.error(error)
          Pop.toast("Something went wrong canceling this GameNight!", 'error')
        }
      },
      ...
      async findGameNight() {
        try {
          ...
          logger.error(error)
          Pop.toast("Something went wrong finding this GameNight!", 'error')
        }
      },
